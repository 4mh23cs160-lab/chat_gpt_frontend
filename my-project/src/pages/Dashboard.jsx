        ...
        const fetchRecentChats = async () => {
            ...
            try {
                ...
                const history = (data.history || []).map(h => ({
                    title: h.message.substring(0, 30) + (h.message.length > 30 ? "..." : ""),
    ...
    return (
        <div className="min-h-screen bg-gray-950 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                <div className="absolute top-0 right-1/4 w-96 h-96 bg-blue-600/5 rounded-full filter blur-3xl"></div>
                <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-cyan-600/5 rounded-full filter blur-3xl"></div>
            </div>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 gap-4">
                    <div>
                        ...
                        <p className="text-gray-400">
                            Here's what's happening with your NovaCore account.
                        </p>
                    </div>
                    <div className="flex items-center gap-3">
                        <button
                            onClick={() => navigate("/")}
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-sm font-semibold text-white transition-all duration-200 shadow-lg shadow-cyan-500/20"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 bg-gray-900/60 backdrop-blur-sm border border-gray-800/60 rounded-2xl p-6">
                        ...
                        <div className="space-y-3">
                            {recentChats.map((chat, index) => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="h-9 w-9 rounded-lg bg-gray-800 flex items-center justify-center group-hover:bg-cyan-500/20 transition-colors">
                                            <svg className="h-4 w-4 text-gray-400 group-hover:text-cyan-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                            </svg>
                                        </div>
                    ...
                    <div className="bg-gray-900/60 backdrop-blur-sm border border-gray-800/60 rounded-2xl p-6">
                        ...
                        <div className="space-y-3">
                            {[
                                { label: "New Chat", icon: "M12 4v16m8-8H4", color: "text-blue-400" },
                                { label: "Create Image", icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z", color: "text-cyan-400" },
